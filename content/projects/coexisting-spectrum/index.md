...
layout: project
type: project
title: "이종신호 중첩·주파수 공유 환경의 신호 인지"
english_title: "Signal Recognition in Coexisting Spectrum Environments"
slug: "coexisting-spectrum-signal-recognition"
project_number: "04"
project_stage: "통신·주파수 공유 연구 · 2021–현재"
research_year: "2021–현재"
hero_claim: "공존·중첩 환경에서의 전파 식별, 다중 라벨 인식, 주파수 공유와 OFDM 신호처리를 연구했습니다."
research_question: "여러 RF 신호가 동일 spectrum에서 공존하거나 중첩되는 환경에서 원하는 신호를 어떻게 탐지·식별·복조할 것인가?"
result_highlight: "전파 식별 · 다중 라벨 인식 · 주파수 공유 · OFDM 처리"
technology_tags:
  - Spectrum Sharing
...
<div class="research-timeline" aria-label="공존 주파수 환경 연구 흐름">
  <div class="research-timeline-item"><strong>2021</strong><span>페이딩 기반 전파식별과 주파수 공유 평가</span></div>
  <div class="research-timeline-item"><strong>2022–2023</strong><span>이종신호 중첩 환경 전파식별·주파수 공유 평가</span></div>
  <div class="research-timeline-item"><strong>2023</strong><span>ResNeXt 기반 LPI 레이다 중첩 신호 다중 라벨 분류</span></div>
  <div class="research-timeline-item"><strong>2024–현재</strong><span>DJI OcuSync 프로토콜 기반 OFDM 드론 신호 복조</span></div>
</div>
...
**LPI 레이다 중첩 신호 인지를 위한 ResNeXt 기반 다중 라벨 분류**<br>
