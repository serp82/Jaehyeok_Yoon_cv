...
layout: project
type: project
title: "이종 신호 공존 환경의 실시간 신호 인지 시스템"
...
hero_claim: "주파수 공유 환경에서 이종 신호를 구분하고, 다중 라벨 인식과 실시간 평가로 연결했습니다."
research_question: "여러 RF 신호가 동일 대역에서 공존하거나 중첩되는 환경에서 원하는 신호를 어떻게 탐지·식별·복조할 것인가?"
result_highlight: "다중 라벨 인식 · 전파 식별·주파수 공유 평가 · OFDM 신호처리"
technology_tags:
  - Spectrum Sharing
...
- **LPI multi-label recognition:** 중첩된 LPI 레이다 신호 인지를 위해 ResNeXt 기반 다중 라벨 분류를 적용합니다.
...
<div class="research-validation" aria-label="공존 신호 연구 결과">
  <span>다중 라벨 인식</span><span>전파 식별·주파수 공유 평가</span><span>OFDM 복조 구현</span>
</div>
