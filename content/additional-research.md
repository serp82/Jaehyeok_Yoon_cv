...
RGB-D 카메라 데이터와 레이더 포인트 클라우드를 활용한 인체 모션 감지 및 스켈레톤 추출 연구입니다.

## FMCW Radar Motion Recognition

**FMCW 레이더 스펙트로그램 기반 동작 인식 기법**<br>
한국통신학회 하계종합학술발표회, 제주 그랜드하얏트호텔, 2022.06 · 학술논문우수상

## UWB NLOS Detection

**Performance Comparison of NLOS Detection Methods in UWB**<br>
International Conference on ICT Convergence (ICTC), Jeju, Korea, 2021.10
