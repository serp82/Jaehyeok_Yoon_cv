...
sections:
  ...
  - block: markdown
    content:
      title: 시스템 개발 역량
      text: |-
        - **신호처리·시뮬레이션**: MATLAB, Python
        - **SDR/RF 개발 환경**: GNU Radio, USRP, HackRF
        - **AI/딥러닝 개발 환경**: PyTorch, TensorFlow, Docker
        - **FPGA 기반 구현**: Verilog HDL, HLS (C/C++), Vivado, RFNoC
        - **이종센서 융합**: ROS-Python 기반 카메라·레이더 센서 융합
